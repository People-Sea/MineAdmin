...
final class TenantRepository extends IRepository
{
    ...
    public function handleSearch(Builder $query, array $params): Builder
    {
        $query
            ...
            ->when(Arr::get($params, 'code'), static function (Builder $query, mixed $code): void {
                $query->where('code', 'like', '%' . $code . '%');
            })
            ->when(Arr::get($params, 'contact_name'), static function (Builder $query, mixed $contactName): void {
                $query->where('contact_name', 'like', '%' . $contactName . '%');
            })
            ->when(Arr::get($params, 'contact_phone'), static function (Builder $query, mixed $contactPhone): void {
            ...
            ->when(Arr::exists($params, 'created_at'), static function (Builder $query) use ($params): void {
