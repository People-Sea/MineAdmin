...
class MenuUpdate20260403PlatformApp extends Seeder
{
    ...
    public function data(): array
    {
        return [
            [
                ...
                'children' => [
                    [
                        'name' => 'platform:platform-app',
                        'path' => '/platform/app',
                        'component' => 'base/views/platform/platform-app/index',
                        'meta' => new Meta([
                            'title' => '平台应用管理',
                            'icon' => 'ri:apps-2-line',
                            'type' => 'M',
                        ...
                        'children' => [
                            [
                                'name' => 'platform:platform-app:index',
                                'meta' => new Meta([
                                    'title' => '平台应用列表',
                                    'type' => 'B',
                                ]),
                            ...
                            [
                                'name' => 'platform:platform-app:save',
                                'meta' => new Meta([
                                    'title' => '平台应用保存',
                                    'type' => 'B',
                                ]),
                            ...
                            [
                                'name' => 'platform:platform-app:update',
                                'meta' => new Meta([
                                    'title' => '平台应用更新',
                                    'type' => 'B',
                                ]),
                            ...
                            [
                                'name' => 'platform:platform-app:disable',
                                'meta' => new Meta([
                                    'title' => '平台应用启停',
                                    'type' => 'B',
                                ]),
