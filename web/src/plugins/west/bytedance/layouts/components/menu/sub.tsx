...
import SubMenu from '$/west/bytedance/layouts/components/menu/sub.tsx'
              ...
              >
                {opened.value && (
                  <OverlayScrollbarsComponent
                    ...
                    class={{
                      'mine-sub-menu': true,
                      'ocMenuPop fixed z-3000 min-w-[150px] max-w-[240px] ing-1 shadow-lg rounded-md pb-[7px] pt-[2px] b-1 b-solid b-gray-2 dark-b-dark-4': rootMenu.isMenuPopup,
