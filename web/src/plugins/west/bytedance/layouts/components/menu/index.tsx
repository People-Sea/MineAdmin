...
export default defineComponent({
  ...
  props: {
    ...
    title: Object as PropType<MineRoute.routeRecord>,
  },
  setup(props) {
    ...
    const { isColumnsLayout, getMenuCollapseState } = useSettingStore()
      ...
      return (
        ...
        >
          <TransitionGroup name="mine-menu">
            <div
              key="menu-title"
              class="ocSubTitle mb-10px mt-28px px-15px text-20px text-[#252931] font-500 leading-28px"
              v-show={isColumnsLayout() && !getMenuCollapseState()}
            >
              { props.title?.meta?.i18n ? t(props.title.meta.i18n) : props.title?.meta?.title }
            </div>
